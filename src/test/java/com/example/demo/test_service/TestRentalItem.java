// L26-2: 連帶撰寫測試檔案，可執行跟 MySQL 資料庫做 CRUD 測試，並印出結果
...
public class TestRentalItem {
	...
	//@Test
	public void find() {
		String keyword = null; // 可換成 "電腦", "4k" 試試
		String type = null; // 可換成 "教室", "設備" , "場地" 試試
